...
> **關於專案更新與發布方式調整的公告**
>
> 鑑於目標網站的反爬蟲機制頻繁更新，導致目前的爬蟲功能壽命極短（通常僅能維持一週），維護與代碼調整頻率過高。為了確保工具的穩定性與可用性，**未來將不再釋出原始碼 (Source Code)。**
>
> 下一版本的更新將改以封裝包 (Packaged/Executable) 的形式發布。目前在整合相關套件依賴時仍面臨一些問題，正致力於解決中。**目標預計在 2025 年底 前釋出新版本。**
>
> 網站篩選上限由41項被下修成包含排除企業為12間，原先上限為20間企業，由於後端限制，改網址是無效的。
