...
def highlight_keywords():
    ...
    highlighted_keywords = list(set(highlighted_keywords))  # 避免重複
...
def highlight_salary_on_page(base_salary, highlight_above, highlight_range, highlight_negotiable):
    """使用 JavaScript 高亮薪資範圍，保留關鍵字高亮"""
    inject_markjs_and_css(driver)  # 確保 Mark.js 已載入
